...
; Sem isto o proprio IsoForge-Setup.exe fica sem versao nas propriedades do
; arquivo: com varios setups na pasta de download, nao havia como saber qual e
; qual sem abrir cada um.
...
[Dirs]
; Pasta compartilhada dos instaladores.
; SEM users-modify, de proposito. A pasta guarda os instaladores que vao DENTRO da
; ISO e que rodam como administrador em toda maquina provisionada. Dar escrita a
; qualquer usuario da maquina de build significa que um usuario sem privilegio
; nenhum aqui troca o conteudo que roda elevado no parque inteiro. Quem executa o
; IsoForge sem ser administrador cai sozinho no cache por usuario
; (%LOCALAPPDATA%\IsoForge\Installers): o InstallerFetcher testa a escrita em
; ProgramData e faz esse desvio no construtor.
Name: "{commonappdata}\IsoForge\Installers"
