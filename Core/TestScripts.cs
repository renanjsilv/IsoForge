...
public static class TestScripts
{
    ...
    /// </summary>
    /// <summary>
    /// Gera o .wsb do Windows Sandbox.
    ///
    /// <paramref name="comRede"/> falso DESLIGA a rede da caixa de teste. Não é um
    /// detalhe: um teste de instalação OFFLINE feito com internet disponível não prova
    /// nada — se o pacote local estiver errado, o instalador simplesmente baixa o que
    /// falta e o teste passa. Só sem rede a pergunta "isso instala numa máquina recém
    /// formatada, sem conexão?" tem resposta.
    /// </summary>
    public static string SandboxWsb(string hostSetupFolder, bool comRede = true)
    {
        var doc = new XElement("Configuration",
            new XElement("MemoryInMB", 4096),
            comRede ? null : new XElement("Networking", "Disable"),
